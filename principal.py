...
APP_VERSION = "20260806-anti-duplicacao-v2"
LIMITES_BRASIL = {
    "min_lat": -34,
    "max_lat": 6,
    "min_lng": -74,
...
def exportar_excel():
    ...
    headers = [
        ...
        "Influencia Apoio do Prefeito", "Demandas Bairro/Povoado", "Aprova Saude Municipio",
    ...
    for row in registros:
        try:
            ...
            ws.append([
                ...
                pesquisa.get("voto_deputado_federal", ""), pesquisa.get("influencia_apoio_prefeito", ""), txt_demandas,
